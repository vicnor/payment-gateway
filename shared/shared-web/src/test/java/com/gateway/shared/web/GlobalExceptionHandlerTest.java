...
class GlobalExceptionHandlerTest {
  ...
  void requestIdFlowsIntoEnvelope() throws Exception {
    mockMvc.perform(get("/test/not-found")).andExpect(jsonPath("$.error.request_id").isNotEmpty());
